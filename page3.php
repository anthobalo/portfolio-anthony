...
<body>
    ...
    <div class="container">
        ...
        <?php
                ...
                $fichier_yaml = 'yaml/page3.yaml';
                $donnees = Yaml::parseFile($fichier_yaml);
                
                if(isset($donnees['Expérience professionnel']['Stage'])) {
                    echo "<ul>";
                    foreach($donnees['Expérience professionnel']['Stage'] as $stage) {
                        echo "<li>{$stage}</li>";
                    }
                    echo "</ul>";
                } else {
                    echo "<p>Aucune expérience professionnelle trouvée.</p>";
                }
            ?>
        </section>
        </div>
